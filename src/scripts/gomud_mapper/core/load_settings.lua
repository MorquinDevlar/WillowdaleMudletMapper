...
function mmp.startup()
  ...
  private_settings["crowdmap"] = mmp.createOption(false, mmp.changeMapSource, {"boolean"}, "Use a crowd-sourced map instead of games default?", nil, {gomud = true})
  ...
  private_settings["fastwalk"] = mmp.createOption(false, mmp.changeBoolFunc, {"boolean"}, "Walk as quick as possible instead of waiting for prompts?")
